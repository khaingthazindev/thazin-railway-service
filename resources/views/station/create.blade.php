...
@section('content')
	<x-card>
		<form id="submit-form" method="post" action="{{ route('station.store') }}" class="tw-mt-6 tw-space-y-6">
			@csrf
...
@push('scripts')
	{!! JsValidator::formRequest('App\Http\Requests\StationStoreRequest', '#submit-form') !!}
